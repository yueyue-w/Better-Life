...
use "/Users/qilinzhou/Desktop/hh_sec_a_2020.dta", clear


merge 1:m y5_hhid using "/Users/qilinzhou/Desktop/hh_sec_c_2020.dta"
drop _merge
save demo_educ_2020.dta, replace
...
use "/Users/qilinzhou/Desktop/demo_educ_2020.dta", clear


rename hh_a06 household_num

. drop y5_cluster-y5_panelweight

. drop strataid domain

. drop loc_info

. drop hh_a03_1-int_result


rename hh_a01_1 region_name

rename hh_a02_1 district_name
...
rename hh_c03_1 never_attend_reason

rename hh_c04 start_school_age
rename hh_c05 in_school
rename hh_c05a absent_reason
...
rename hh_c18 absent_reason_2w
...
rename hh_c28_2 book_mat

rename hh_c28_3 uniform_fee

rename hh_c28_4 transport_fee
...
save cleaned_educ_2020.dta, replace

use "/Users/qilinzhou/Desktop/hh_sec_b_2020.dta", replace
merge 1:1 y5_hhid indidy5 using "/Users/qilinzhou/Desktop/cleaned_educ_2020.dta"
drop _merge

save cleaned_educ_2020.dta, replace
use "/Users/qilinzhou/Desktop/cleaned_educ_2020.dta", replace

rename hh_b02 sex
rename hh_b04 age
rename hh_b05 relation_head
drop hh_b06-hh_b13
drop hh_b15_1-hh_b16
...
gen rural = .
replace rural = 1 if y5_rural == 1
replace rural = 0 if y5_rural == 2

order rural, after(y5_rural)
drop y5_rural
...
save "encoded_educ_2020.dta",replace
